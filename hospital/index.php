    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">HPA
                    ...
                    <div id="menu" class="col-lg-8 col-md-9 d-none d-md-block nav-item">
                        <ul>
                            ...
                            <li class="home"><a href="#about_us">About Us</a></li>
                            <li class="home"><a href="#gallery">Gallery</a></li>
                            <li class="home"><a href="#contact_us">Contact Us</a></li>
                            <li class="home"><a href="#logins">Logins</a></li>  
                        </ul>
                    </div>
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">HealthPro Academy</h5>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                        ...
                        <h5><a href="hms/cardiology.html" target="_blank">Cardiology</a></h5>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                        ...
                        <a href="hms/Orthopaedic.html" target="_blank"><h5>Orthopaedic</h5></a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                       ...
                       <a href="hms/Neurologist.html" target="_blank"><h5>Neurologist</h5></a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                        ...
                        <a href="hms/lab.html" target="_blank"><h5>High Quality treatments</h5></a>
